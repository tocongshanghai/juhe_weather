...
import com.tocong.juhe_weather_application.service.WeatherService;
import com.tocong.juhe_weather_application.service.WeatherService.WeatherServiceBinder;
import com.tocong.juhe_weather_application.service.WeatherService.onParseCallBack;
...
private void setWeatherViews(WeatherBean bean) {
    ...
    List<com.tocong.juhe_weather_application.bean.FutureWeatherBean> futureList = bean.getFutureList();
...
private void setFutureData(TextView tv_week, ImageView iv_weather, TextView tv_temp_a, TextView tv_temp_b, com.tocong.juhe_weather_application.bean.FutureWeatherBean bean) {
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == 1 && resultCode == 1) {
			...
			mService.getCityWeather(cityString);
